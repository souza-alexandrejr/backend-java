package com.backend.java.product.api.exception.advice;
...
@ControllerAdvice(basePackages = "com.backend.java.product.api.controller")
public class ProductControllerAdvice {
	...
	public ErrorDTO processValidationError(MethodArgumentNotValidException methodArgumentNotValidException) {
		...
		StringBuilder sb = new StringBuilder("Invalid value for the field(s):");
